...
-- SELECT * FROM university_khl.student;
--  insert into student(st_num, st_pw, st_id,  st_name, st_reg_num)
--  values('2021160015','pwkim','kimid','김영희','021225-4654321');
  
--  insert into student 
--  values(2021160123, 'hong', 'hongkpw', '홍길동','020101-3456789');
--  values(2021123005, 'park', 'parkpw', '박철수','021221-4443332'),(2021456005, 'parkid', 'parkpw', '박수철','020808-3985612');
