...
-- (sc_num, mo_num, th_num, sc_date, sc_time,
...
-- insert into ticketing(ti_num, me_id, sc_num)
-- values(1, 'abc123', 2), (2, 'abc123', 2);

-- sc_num from schedule
-- 	where sc date = '2021-12-01' and sc_time = '21:20' and sc_room_num = 1
...
-- 3. 티케팅리스트 추가
-- insert into ticketing_list (tl_num, ti_num, st_num)
-- values(1, 1, 1), (2, 2, 2);
