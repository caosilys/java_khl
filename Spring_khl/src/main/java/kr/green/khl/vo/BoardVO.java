...
public class BoardVO {
		...
		public String toString() {
			return "BoardVO [bd_num=" + bd_num + ", bd_title=" + bd_title + ", bd_content=" + bd_content
					+ ", bd_reg_date=" + bd_reg_date + ", bd_up_date=" + bd_up_date + ", bd_type=" + bd_type
					+ ", bd_me_id=" + bd_me_id + ", bd_ori_num=" + bd_ori_num + ", bd_del=" + bd_del + ", bd_del_date="
					+ bd_del_date + "]";
		}
